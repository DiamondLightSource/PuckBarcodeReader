...
#> replaced with >= in the return statement
    ...
    def test_paste_when_location_is_inside_image_3_channels(self):
        ...
        self.assertEqual(image_target.img[0, 0, 1], 2)
        self.assertEqual(image_target.img[0, 1, 1], 0)
    ...
    def test_paste_when_location_is_inside_image_4_channels_no_blending_when_source_alpha_is_255(self):
        ...
        self.assertEqual(a, b) #target changed into source
    ...
    def target_image_alpha_becomes_255_after_paste(self):
        ...
        self.assertEqual(max_alpha_before_paste, 10)
        self.assertEqual(max_alpha_after_paste, 255) #I expected it to be as it was before
    ...
    def test_draw_circle_thickness_equals_one(self):
        ...
        self.assertEqual(img.img[10][20][1], 200)
        self.assertEqual(img.img[9][20][1], 0)
        self.assertEqual(img.img[11][20][1], 0)

    def test_draw_circle_thickness_equals_two(self):
        img = Image.blank(40, 40)
        circle = Circle(Point(20, 20), 10)
        img.draw_circle(circle, Color(200, 200, 200), 2)
        self.assertEqual(img.img[8][20][1], 0)
        self.assertEqual(img.img[10][20][1], 200)
        self.assertEqual(img.img[9][20][1], 200)
        self.assertEqual(img.img[11][20][1], 200)
        self.assertEqual(img.img[12][20][1], 0)

    def test_draw_circle_thickness_equals_three(self):
        img = Image.blank(40, 40)
        circle = Circle(Point(20, 20), 10)
        img.draw_circle(circle, Color(200, 200, 200), 3)
        self.assertEqual(img.img[7][20][1], 0)
        self.assertEqual(img.img[8][20][1], 200)
        self.assertEqual(img.img[10][20][1], 200)
        self.assertEqual(img.img[9][20][1], 200)
        self.assertEqual(img.img[11][20][1], 200)
        self.assertEqual(img.img[12][20][1], 200)
        self.assertEqual(img.img[13][20][1], 0)
    ...
    def test_draw_circle_thickness_equals_four(self):
        ...
        self.assertEqual(img.img[6][20][1], 0)
        self.assertEqual(img.img[7][20][1], 0)#!!
        self.assertEqual(img.img[8][20][1], 200)
        self.assertEqual(img.img[10][20][1], 200)
        self.assertEqual(img.img[9][20][1], 200)
        ...
        self.assertEqual(img.img[12][20][1], 200)
        self.assertEqual(img.img[13][20][1], 0)#!!
        self.assertEqual(img.img[14][20][1], 0)
    ...
    def test_draw_circle_centre_is_kept(self):
        ...
        img.draw_circle(circle, Color(200, 200, 200), 1)
        self.assertEqual(img.img[18][20][1], 0)
        self.assertEqual(img.img[19][20][1], 200)
        self.assertEqual(img.img[20][20][1], 0)
        self.assertEqual(img.img[21][20][1], 200)
        self.assertEqual(img.img[22][20][1], 0)

        self.assertEqual(img.img[20][18][1], 0)
        self.assertEqual(img.img[20][19][1], 200)
        self.assertEqual(img.img[20][20][1], 0)
        self.assertEqual(img.img[20][21][1], 200)
        self.assertEqual(img.img[20][22][1], 0)
    ...
    def test_sub_image_is_square_with_side_length_2_radius_if_enough_space_to_cut_from(self):
        ...
        self.assertEqual(width, 2*radius)
        self.assertEqual(height, 2*radius)
